  ...
  const giwaPatternItems = [
    {
      ...
      desc: (
        <>
          ...
          정신적으로 힘든 상태의 사람에게 전해주면 보다 긍정적인 효과를 기대할
          수 있습니다. <br />
    ...
    },
    {
      ...
      desc: (
        <>
          ...
          <br />
          목소리의 영향력이 없으신 분에게 효과적입니다. 혹은 말의 화가 많아
          대화가 어려운 사람에게 준다면, 감정컨트롤 효과가 높아지고 소통능력이
          향상됩니다.
          <br />
    ...
    },
    {
      ...
      desc: (
        <>
          ...
          <br />
          이성이 없는 사람에게는 새로운 만남이 생길 확률이 높아집니다. 반대로
          이미 짝이 있는 경우에는, 오히려 금술이 단단해져 결혼할 기회까지 오게
          됩니다.
          <br />
          사랑은 순수우리말로 사람이나 존재를 몹시 아끼고 귀중히 여기는
          마음이라는 의미를 가지고 있습니다.
        </>
      ),
    },
    ...
    },
    {
      ...
      desc: (
        <>
          ...
          에너지가 넘치게 됩니다.
          <br />
          올차다의 뜻은 순수 우리말로 허술한 데가 없이 야무지고 기운차다는
          의미를 가지고 있습니다.
        </>
      ),
    },
    ...
    },
    {
      ...
      desc: (
        <>
          이 기와는 의지를 주는 기와입니다.
          <br /> 삶의 자신이 없거나, 업에 대한 회의감이 드는 사람에게 사용할
          경우 강한 의지력을 전달해줄 수 있습니다. 반대로 이미 그러한 상태의
          사람에게 사용할 경우에는 세상을 바꿀 힘을 가져다 줄 수도 있습니다.
          <br /> 존경은 한자어로 고남의 인격, 사상, 행위 따위를 받들어
          공경함라는 의미를 가지고 있습니다.
        </>
      ),
    },
    {
      ...
      desc: (
        <>
          이 기와는 인복이 상승하는 기와입니다. <br />
          빈 바구니에 다양한 것을 담을 수 있듯이 다양한 사람을 만나 이야기를
          듣게 되는 운이 들어오는 운입니다. 새로운 인복이 필요하거나, 외로움이
          많은 사람 혹은 삶의 지루함을 느낀 사람에게 이 기와가 갈 경우
          효과적입니다. <br />
    ...
    },
    {
      ...
      desc: (
        <>
          ...
          <br />
          중요한 시험을 준비하거나, 결과를 기다릴 경우에 좋은 운을 가져다
          줍니다. 본인이 공부한 것, 체크한 부분에 대해서 문제가 나올 가능성이
          높아집니다. 이 기와의 경우 본인이 노력한 것에 대한 결과를 받을 수 있을
          뿐, 의외의 높은 결과를 기대하긴 어렵습니다.
          <br />
